                ...
                <thead class="bg-light">
                  <tr>
                    ...
                    <th>
                      ...
                      <a href='lstudents_c.php' class='btn btn-primary bi bi-table' role='button' title = 'Add'></a>
                      </li>
                    </th>
                  ...
                  if ($stmt1) {
                    ...
                    while($row = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          echo "<td>" ;
                            ...
                            echo    "<div class='round-button'><div class='round-button-circle'><a href='lstudents_r.php?id=".urlencode($row['studentID'])."' class='round-button'>".$row['initial']."</a></div></div>";
                            echo      "<div class='ms-3'>";
                          ...
                          echo "<a href='lstudents_r.php?id=".urlencode($row['studentID'])."' class='btn btn-secondary bi bi-card-text' role='button' title = 'Detail'></a>";
                          echo "</li>";

                          echo "<li class='list-inline-item'>";
                          echo "<a href='lstudents_u.php?id=".urlencode($row['studentID'])."' class='btn btn-success bi bi-pencil-square' role='button' title = 'Edit'></a>";
                          echo "</li>";

                          echo "<li class='list-inline-item'>";
                          echo "<a href='lstudents_d.php?id=".urlencode($row['studentID'])."' onclick='return confirm(\"Are you sure you want to delete?\");' class='btn btn-danger bi bi-trash' role='button' title = 'Delete'></a>";
                          echo "</li>";
