                ...
                <thead class="bg-light">
                  <tr>
                    ...
                    <th>
                      ...
                      <a href='aleaders_c.php' class='btn btn-primary bi bi-table' role='button' title = 'Add'></a>
                      </li>
                    </th>
                  ...
                  if ($stmt1) {
                    ...
                    while($row = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          echo "<td>" ;
                            ...
                            echo    "<div class='round-button'><div class='round-button-circle'><a href='aleaders_r.php?id=".urlencode($row['leaderID'])."' class='round-button'>".$row['initial']."</a></div></div>";
                            echo      "<div class='ms-3'>";
                          ...
                          echo "<a href='aleaders_r.php?id=".urlencode($row['leaderID'])."' class='btn btn-secondary bi bi-card-text' role='button' title = 'Detail'></a>";
                          echo "</li>";

                          echo "<li class='list-inline-item'>";
                          echo "<a href='aleaders_u.php?id=".urlencode($row['leaderID'])."' class='btn btn-success bi bi-pencil-square' role='button' title = 'Edit'></a>";
                          echo "</li>";

                          echo "<li class='list-inline-item'>";
                          echo "<a href='aleaders_d.php?id=".urlencode($row['leaderID'])."' onclick='return confirm(\"Are you sure you want to delete?\");' class='btn btn-danger bi bi-trash' role='button' title = 'Delete'></a>";
                          echo "</li>";
