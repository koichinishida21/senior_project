...
if ($stmt) {
  ...
  while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo "<a href='lhigh.php?id=".urlencode($row['schoolID'])."' class = 'btn' role = 'button'>";
    } else if($row['type'] == 'Middle School'){
    echo "<a href='lmiddle.php?id=".urlencode($row['schoolID'])."' class = 'btn' role = 'button'>";
    } else if($row['type'] == 'College'){
    echo "<a href='lcollege.php?id=".urlencode($row['schoolID'])."' class = 'btn' role = 'button'>";
  } else if($row['type'] == 'No School'){
    echo "<a href='lnoschool.php?id=".urlencode($row['schoolID'])."' class = 'btn' role = 'button'>";
    }
