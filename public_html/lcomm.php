            ...
            require_once("database.php");
                  ...
                  if ($stmt1) {
                    ...
                    while($row = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          echo "<td>" ;
                            ...
                            echo    "<div class='round-button'><div class='round-button-circle'><a href='lcomm_r.php?id=".urlencode($row['committeeID'])."' class='round-button'>".$row['initial']."</div></div>";
                            echo      "<div class='ms-3'>";
                            ...
                            echo "<a href='lcomm_r.php?id=".urlencode($row['committeeID'])."' class='btn btn-secondary bi bi-card-text' role='button' title = 'Detail'></a>";
                            echo "</li>";
                          echo "</tr>";
                        }
                        echo "</tbody>";
              ...
              if ($stmt) {
                ...
                while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  echo  "<td>";
                  echo    "<div class='d-flex align-items-center'>";
                  echo    "<div class='round-button'><div class='round-button-circle'><a href='lcomm_r.php?id=".urlencode($row['committeeID'])."' class='round-button'>".$row['initial']."</a></div></div>";
                  echo      "<div class='ms-3'>";
                  echo        "<p class='fw-bold mb-1' style='color: black'>".$row['fullName']."</p>";
                  echo      "</div>";
                  echo    "</div>";
