...
if(isset($_SESSION["lusername"]) && $_SESSION["lusername"] !== ""){
  ...
  && (!empty($_POST['state'])) && (!(trim($_POST['state']) == ""))){
      ...
      echo "<form action='aprofile.php' method='POST'>\n";
      echo "<div class='row'>\n";
      ...
      echo "<center>";
      echo "<input type='submit'  class='btn btn-info' name='submit1' value='Update'/>\n";
      echo "</center>";
			echo "</form>\n";
			echo "</div>\n";
      echo "</div>";
  ...
  }else if(isset($_SESSION["cusername"]) && $_SESSION["cusername"] !== ""){
