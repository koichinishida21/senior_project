          ...
          if ($stmt1) {
            ...
            while($row = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  echo "<td>" ;
                    ...
                    echo    "<div class='round-button'><div class='round-button-circle'><a href='cleaders_r.php?id=".urlencode($row['leaderID'])."' class='round-button'>".$row['initial']."</a></div></div>";
                    echo      "<div class='ms-3' >";
                    ...
                    echo "<a href='cleaders_r.php?id=".urlencode($row['leaderID'])."' class='btn btn-secondary bi bi-card-text' role='button' title = 'Detail'></a>";
                    echo "</li>";
                    echo  "</td>";
